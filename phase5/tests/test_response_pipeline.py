...
# Real-log gate 2026-08-30: main.py's per-turn dict init archives
# llm_response:null on EVERY turn (incl. dropped) — run_turn mirrors that.
check("no response fields", t.get("llm_response") is None and "engine_path" not in t, True)
