...
OWNER's baseline logs (frozen build f7937a4, §5 protocol) replay with an
empty diff. The owner archive (logs/baseline_20260830_1/session_20260830_175618.log)
now replays through the same gate — see replay.py. Synthetic stays a
regression guard, never the proof.
...
def write_fixture(turns, path: Path):
    ...
    manifest = {
        ...
        "note": "SYNTHETIC placeholder — generated by phase5/harness/"
                ...
                "(frozen build f7937a4, §5 protocol) replay EMPTY — see "
                "logs/baseline_20260830_1/. Owner archives replace this "
                "fixture.",
